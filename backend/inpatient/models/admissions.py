...
class AdmissionRequest(models.Model):
    ...
    ward = models.ForeignKey(
        "inpatient.Ward", on_delete=models.PROTECT, related_name="admission_requests",
...
class BedTransfer(models.Model):
    ...
    from_occupancy = models.ForeignKey(
        "inpatient.BedOccupancy", on_delete=models.PROTECT, related_name="transfers_out"
    )
    to_occupancy = models.ForeignKey(
        "inpatient.BedOccupancy", on_delete=models.PROTECT, related_name="transfers_in"
    )
